...
Puppet::Type.type(:gcompute_health_check).provide(:google) do
  ...
  def resource_to_request
    request = {
      kind: 'compute#healthCheck',
      checkIntervalSec: @resource[:check_interval_sec],
      description: @resource[:description],
      healthyThreshold: @resource[:healthy_threshold],
      name: @resource[:name],
      timeoutSec: @resource[:timeout_sec],
      unhealthyThreshold: @resource[:unhealthy_threshold],
      type: @resource[:type],
      httpHealthCheck: @resource[:http_health_check],
      httpsHealthCheck: @resource[:https_health_check],
      tcpHealthCheck: @resource[:tcp_health_check],
      sslHealthCheck: @resource[:ssl_health_check]
    }.reject { |_, v| v.nil? }
