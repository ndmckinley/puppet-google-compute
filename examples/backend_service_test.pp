...
gauth_credential { 'mycred':
  path     => "/home/nmckinley/.gcloud/Terraform.json", # e.g. '/home/nelsonjr/my_account.json'
...
gcompute_zone { 'us-central1-a':
  project    => "personal-graphite-testing", # e.g. 'my-test-project'
  credential => 'mycred',
}
...
gcompute_backend_service { 'my-app-backend':
  ...
  enable_cdn    => true,
  health_checks => [
    gcompute_health_check_ref('my-hc', "personal-graphite-testing"),
  ],
  project       => "personal-graphite-testing", # e.g. 'my-test-project'
  credential    => 'mycred',
}
